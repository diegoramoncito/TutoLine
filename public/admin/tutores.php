  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <a href="tutor.php" class="btn btn-primary">Crear</a>
        </div>
        <div class="card-body">
          <table id="dataTable" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="tutor.php?passport=<?php echo $element['id_tutor']; ?>" class="btn btn-info">Editar</a><a href="delete.php?route1=5&passport=<?php echo $element['id_tutor']; ?>" class="btn btn-danger">Eliminar</a></td>
              </tr>
              <?php
              }
              ?>

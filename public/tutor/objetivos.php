          ...
          <table id="dataTable" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="objetivo.php?passport=<?php echo $element['id_objetivo']; ?>" class="btn btn-info">Editar</a><a href="controller.php?route3=3&passport=<?php echo $element['id_objetivo']; ?>" class="btn btn-danger">Eliminar</a></td>
              </tr>
              <?php } ?>
            </tbody>
            <tfoot>
